...
write.csv (estimators_vole, "../data_supp/parameters_vole_step1.csv", row.names = T, quote = F)
write.csv (estimators_predators, "../data_supp/parameters_predators_step1.csv", row.names = T, quote = F)
...
parameters <- read.csv("../data_supp/parameters_vole_step1.csv", sep=",", header=T, dec=".",stringsAsFactors=FALSE)
parameters_pred <- read.csv("../data_supp/parameters_predators_step1.csv", sep=",", header=T, dec=".",stringsAsFactors=FALSE)
...
for (scenario in 1:8){ 
  ...
  for (zone in 1:3){
    ...
    # calcul : from seasonal density dependence to annual density dependence 
...
write.csv (Vole, "../data_supp/vole_density_simulations_step1.csv", row.names = T, quote = F) 
write.csv (simulations, "../data_supp/simulations_indicators_step1.csv",row.names=T,quote=F)

#--------------------------------------------------------------------------------------------------------

# III Figures : direct and delayed density dependence + s-index 

simulations <- read.csv("../data_supp/simulations_indicators_step1.csv",sep=",", header=T, dec=".", stringsAsFactors=FALSE)

# data cleaning 
simulations$direct.density.dependence[simulations$direct.density.dependence>40 ] <- NA
simulations$delayed.density.dependence[simulations$delayed.density.dependence>40] <- NA
...
simulations$min_n[simulations$min_n<(-40)] <- NA
simulations$max_n[simulations$max_n<(-40)] <- NA
simulations$delayed.density.dependence[is.na(simulations$direct.density.dependence)] <- NA
simulations$direct.density.dependence[is.na(simulations$delayed.density.dependence)] <- NA
...
pdf("../Figures_supp/graph_triangle_step1.pdf",  
    width = 16, height = 12, 
    bg = "white",         
    colormodel = "cmyk")
...
pdf("../Figures_supp/graph_s_index_step1.pdf",  
    width = 12, height = 6, 
    bg = "white",         
    colormodel = "cmyk")
...
# data importation 
Vole <- read.csv("../data_supp/vole_density_simulations_step1.csv",sep=",", header=T, dec=".", stringsAsFactors=FALSE)
...
pdf("../Figures_supp/sim_north_step1.pdf",  
    width = 8, height = 18, 
    bg = "white",         
    colormodel = "cmyk")
...
# Opening the graphic device 
pdf("../Figures_supp/sim_east_step1.pdf",  
    width = 8, height = 18, 
    bg = "white",         
    colormodel = "cmyk")
...
# Opening the graphic device 
pdf("../Figures_supp/sim_west_step1.pdf",  
    width = 8, height = 18, 
    bg = "white",         
    colormodel = "cmyk")
